...
gameDisplay = display.set_mode((display_h,display_w))
display.set_caption('Bori Snake')

snakeimg = image.load('snakehead.png')
starthead = image.load('snahead.png')
startapple = image.load('snakeappl2.jfif')
icon = image.load('snahead22.png')
appleimg = image.load('snakeappl2py.jpg')
appleimg2 = image.load('ssnakeapp1py.jpg')
display.set_icon(icon)

#time.
#font
tinyfont = font.SysFont("comicsansms",20)
smallfont = font.SysFont("comicsansms",25)
midfont = font.SysFont("comicsansms",50)
bigfont = font.SysFont("comicsansms",85)
